...
\fancyhead[R]{
\textbf{UC – Programação para a Internet 2 (ProgWeb 2)}\\
...
\begin{center}
    {\Large \textbf{PROGRAMAÇÃO PARA A INTERNET 2 (PROGWEB 2)}}\\
...
\newpage
\input{roteiro-1/content.tex}
\newpage
\input{roteiro-2/content.tex}
